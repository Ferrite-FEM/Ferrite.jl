...
@testset "ip=$scalar_interpol quad_rule=$(typeof(quad_rule))" for (scalar_interpol, quad_rule) in  (
                                    ...
                                    (ArbitraryOrderLagrange{RefTriangle, 3}(), QuadratureRule{RefTriangle}(2)),
                                    (ArbitraryOrderLagrange{RefTriangle, 4}(), QuadratureRule{RefTriangle}(2)),
                                    (ArbitraryOrderLagrange{RefTriangle, 5}(), QuadratureRule{RefTriangle}(2)),
