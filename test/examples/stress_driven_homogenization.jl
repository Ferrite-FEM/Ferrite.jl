# Test the stress_driven_homogenization tutorial script
module TestStressDrivenHomogenization
mktempdir() do dir
    cd(dir) do
        ...
        include(joinpath(@__DIR__, "../../docs/src/literate-tutorials/stress_driven_homogenization.jl"))
    end
end
end
