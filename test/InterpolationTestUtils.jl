...
function test_continuity(
    ...
    @test isapprox(d1, d2; rtol = 1.0e-6) # Approximate points can contribute to the inexactness
    return true
end
...
function test_gradient(dh, cellnr; ΔL = 1.0e-6)
    ...
    @test isapprox(Δu_num, Δu_ana; rtol = 1.0e-6)
    return nothing
end
