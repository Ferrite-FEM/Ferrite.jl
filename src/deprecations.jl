...
@deprecate PointVectorValues(::Type{T}, ip::ScalarInterpolation, ipg::Interpolation = default_geometric_interpolation(ip)) where {T} PointVectorValues(T, VectorizedInterpolation(ip), ipg)
