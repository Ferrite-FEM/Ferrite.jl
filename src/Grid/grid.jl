...
default_interpolation(::Union{Type{Quadrilateral}}) = Lagrange{2,RefCube,1}()
default_interpolation(::Union{Type{Quadrilateral3D}}) = ShellInterpolation(Lagrange{2,RefCube,1}())
