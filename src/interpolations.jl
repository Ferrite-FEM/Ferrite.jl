...
"""
function transfer_point_cell_to_face(point::Union{Vec{2, T}, Vector{T}}, cell::Type{RefTriangle}, face::Int) where T
    x, y = point
...
"""
function transfer_point_cell_to_face(point::Union{Vec{3, T}, Vector{T}}, cell::Type{RefTetrahedron}, face::Int) where T
    x, y, z = point
