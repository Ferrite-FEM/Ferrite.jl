...
Algebraic variables count as fields here: they follow after all spatial fields, in
declaration order, and `target_blocks` (if passed) must include entries for them.
