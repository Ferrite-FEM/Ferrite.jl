...
function _add!(ch::ConstraintHandler, dbc::Dirichlet, bcfaces::Union{Set{FaceIndex},Set{EdgeIndex},Set{VertexIndex}}, interpolation::Interpolation, field_dim::Int, offset::Int, bcvalue::BCValues, functype::Function)
...
function _add!(ch::ConstraintHandler, dbc::Dirichlet, bcnodes::Set{Int}, interpolation::Interpolation, field_dim::Int, offset::Int, bcvalue::BCValues)
