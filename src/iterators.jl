...
reinit!(iv::InterfaceValues, ic::InterfaceCache) = reinit!(iv, ic.a.current_faceid[],
    ic.b.current_faceid[], getcoordinates(ic.a), getcoordinates(ic.b), 
    getcells(ic.a.cc.grid, cellid(ic.a)), getcells(ic.b.cc.grid, cellid(ic.b)))
