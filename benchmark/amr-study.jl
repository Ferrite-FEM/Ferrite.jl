...
#----------------------------------------------------------------------#
# A standalone exploratory script (scaling study, complexity and memory analysis) --
# not part of the CI suite; the suite's `amr` group lives in benchmarks-amr.jl.
# Run standalone:
#   julia --project benchmark/amr-study.jl
